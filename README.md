...
### Project Title 1 — Customer Shopping Behavior Dashboard with Power BI

<table>
<tr>
<td width="50%">
  <img src="Screenshot 2026-08-12 172008.png" alt="Project 1 Placeholder" width="100%"/>
</td>
<td width="50%">
...
The screenshot shows the report filtered to **male, subscribed customers** — 1,053 customers (~27% of the base) generating $62.65K in revenue.
